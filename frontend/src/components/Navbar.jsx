        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                ...
                <button
                    ...
                    className='flex flex-col items-center gap-1 text-gray-700 hover:text-black transition duration-200'
                >
                    <p>ADMIN PANEL</p>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    {/* ✅ Admin Panel link inside mobile sidebar */}
                    <button
                        onClick={() => {
                            openAdminPanel();
                            setVisible(false);
                        }}
                        className='py-2 pl-6 border text-left hover:text-black'
                    >
                        ADMIN PANEL
                    </button>
                </div>
